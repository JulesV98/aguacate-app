<template>
    <div>
      ...
      <div class="Login">
        ...
        <form id="forma" name="forma" @submit.prevent="agregarUsuario()" v-if="!editar">

          <div class="element">
            <label for="usuario">Nombre</label>
            <input type="text" id="Nombre" name="Nombre" v-model="usuario.nombre"/>
          </div>

          <div class="element">
            <label for="usuario">Apellidos</label>
            <input type="text" id="Apellidos" name="Apellidos" v-model="usuario.apellido"/>
          </div>
          
          <div class="element">
            <label for="usuario">Telefono</label>
            <input type="text" id="Telefono" name="Telefono" v-model="usuario.telefono"/>
          </div>

          <div class="element">
            <label for="usuario">Email</label>
            <input type="text" id="Email" name="Email" v-model="usuario.correo"/>
          </div>

          <div class="element">
            <label for="usuario">Ciudad</label>
            <input type="text" id="Ciudad" name="Ciudad" v-model="usuario.ciudad"/>
          </div>

          <div class="element">
            <label for="password">Contraseña</label>
            <input type="password" id="password" name="password" v-model="usuario.contraseña" />
          </div>
          ...
          <b-button type="submit" class="boton-personalizado" v-on:click="di('Registro exitoso')"><a href="/panel-usuario">Registrarme</a></b-button>
          <button type="button" class="element">
            <router-link to="/" class="boton_personalizado" tag="button">Salir</router-link>  
          </button>
        </form>
      </div>
      <footer class="footer">
...
export default {
    ...
    data() {
        return {
            ...
            usuario:{nombre:"",apellido:"",telefono:"",correo:"",ciudad:"",contraseña:""},
            editar:false,
        }
...
#Nosotros .TextoNosotros .TituloNosotros {
  margin-bottom: 30px;
  color: black;
  font-style: italic;
  font-weight: 300;
...
/*barra largo*/
#Nosotros .TextoNosotros .TituloNosotros:after {
  content: "";
  position: absolute;
  bottom: 0;
  width: 40px;
