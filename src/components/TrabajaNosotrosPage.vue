    ...
    <div>
      ...
      <div class="container">
        ...
        <div class="TextoNosotros">
            <h2 class="TituloNosotros">Forma parte de la gran red de vendedores</h2>
            <p class="ParrafoNosotros">
            Haz parte de la red mas grande de vendedores de aguacates de la ciudad
            </p>
            <p class="ParrafoNosotros">
            Haz parte de la red mas grande de vendedores de aguacates de la ciudad
            </p>
            ...
            <center>
            <div class="element">
                <router-link to="/signin" class="boton_personalizado" tag="button">Registrarse</router-link>  
            </div>
            </center>
        </div>
        </div>
...
#TrabajaNosotros .TextoNosotros .TituloNosotros {
  margin-bottom: 30px;
  color: black;
  font-style: italic;
  font-weight: 300;
...
/*barra largo*/
#TrabajaNosotros .TextoNosotros .TituloNosotros:after {
  content: "";
  position: absolute;
  bottom: 0;
  width: 40px;
